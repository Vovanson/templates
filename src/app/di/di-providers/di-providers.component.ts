...
import { HeroService } from '../di-angular/heroes/hero.service';
import { heroServiceProvider } from '../di-angular/heroes/hero.service.provider';
...
export class Provider1Component {
  ...
  constructor(logger: Logger) {
    ...
    console.log('Provider1Component', logger);
  }
}
...
export class Provider4Component {
  ...
  constructor(logger: Logger) {
    ...
    this.log = logger.logs[0];
    console.log('Provider4Component', logger);
  }
}
...
export class Provider5Component {
  ...
  constructor(logger: Logger) {
    ...
    this.log = logger.logs[0];
    console.log('Provider5Component', logger);
  }
}
...
export class Provider6aComponent {
  ...
  constructor(newLogger: NewLogger, oldLogger: OldLogger) {
    ...
    console.log('Provider6aComponent', newLogger, oldLogger);
  }
}
...
export class Provider6bComponent {
  ...
  constructor(newLogger: NewLogger, oldLogger: OldLogger) {
    ...
    console.log('Provider6bComponent', newLogger, oldLogger);
  }
}
...
export class Provider7Component {
  ...
  constructor(logger: Logger) {
    ...
    this.log = logger.logs[0];
    console.log('Provider7Component', logger);
  }
}
